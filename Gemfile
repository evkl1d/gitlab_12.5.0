...
gem 'fog-local', '~> 0.7', '>= 0.7.0'
gem 'fog-openstack', '~> 1.0', '>= 1.0.9'
gem 'fog-rackspace', '~> 0.1.2'
gem 'fog-aliyun', '~> 0.3', '>= 0.3.4'
...
gem 'aws-sdk'
gem 'faraday_middleware-aws-signers-v4', '>= 0.1.8'

# Markdown and HTML processing
gem 'html-pipeline', '~> 3.0', '>= 3.0.0'
gem 'deckar01-task_list', '2.3.0'
...
# Memory benchmarks
gem 'derailed_benchmarks', '>= 1.3.6', require: false
...
group :development do
  ...
  gem 'danger', '~> 6.1', '>= 6.1.0', require: false
